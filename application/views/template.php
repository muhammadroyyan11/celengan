...
<body class="vertical-layout vertical-menu-modern semi-dark-layout content-left-sidebar email-application navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar" data-layout="semi-dark-layout">
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a href="<?= site_url('dashboard') ?>"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
                </li>
                <li class=" navigation-header"><span>Money</span>
                </li>
                <li class="nav-item"><a href="<?= site_url('keuangan') ?>"><i class="feather icon-x-circle"></i><span class="menu-title" data-i18n="Tanggungan">Keuangan</span></a>
                </li>
                <li class="nav-item"><a href="#"><i class="feather icon-x-circle"></i><span class="menu-title" data-i18n="Tanggungan">Tanggungan</span></a>
                </li>
                <li class=" navigation-header"><span>Control</span>
                </li>
                <li class="nav-item"><a href="<?= site_url('categori') ?>"><i class="feather icon-save"></i><span class="menu-title" data-i18n="Laporan">Categori</span></a>
                </li>
                <li class="nav-item"><a href="<?= site_url('laporan') ?>"><i class="feather icon-save"></i><span class="menu-title" data-i18n="Laporan">Laporan</span></a>
                </li>
                <?php if (is_admin()) { ?>
                    <li class=" navigation-header"><span>User Management</span>
                    </li>
                    <li class="nav-item"><a href="<?= site_url('user') ?>"><i class="feather icon-users"></i><span class="menu-title" data-i18n="User Management">User Management</span></a>
                    </li>
                <?php } ?>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021<a class="text-bold-800 grey darken-2" href="#">Celengan,</a>All rights Reserved</span><span class="float-md-right d-none d-md-block">Hand-crafted & Made with<i class="feather icon-heart pink"></i></span>
